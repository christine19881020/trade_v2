<template>
	<div class="simple-stack" v-loading="loading" >
		<div class="page page-1" @click="$router.push('/task/list')">
			111
		</div>
		<div class="page page-2" @click="$router.push('/task/product/1')">
			222
		</div>
		<div class="page page-root" style="margin-top:-192px;">
			...
			<div class="taskdetail">
				<ul class="smalltasks">
					<li v-for="(item,index) in smalltasks">
